...
START_TEST(test_derive_01)
{
    ...
    fail_unless_equal("Result", "%" PRIu64,  1, bws_derive_inc(frog));
    fail_unless_equal("Result", "%" PRIu64, 10, bws_derive_add(cat, 10));
    fail_unless_equal("Result", "%" PRIu64,  2, bws_derive_inc(frog));
    fail_unless_equal("Result", "%" PRIu64,  3, bws_derive_inc(frog));
    fail_unless_equal("Result", "%" PRIu64, 10, bws_derive_add(dog, 10));
    ...
    fail_unless_equal("Result", "%" PRIu64, 15, bws_derive_add(dog, 5));
    fail_unless_equal("Result", "%" PRIu64,  4, bws_derive_inc(frog));
...
START_TEST(test_gauge_01)
{
    ...
    fail_unless_equal("Result", "%" PRIu64,  1, bws_gauge_inc(frog));
    fail_unless_equal("Result", "%" PRIu64, 10, bws_gauge_add(cat, 10));
    fail_unless_equal("Result", "%" PRIu64,  2, bws_gauge_inc(frog));
    fail_unless_equal("Result", "%" PRIu64,  3, bws_gauge_inc(frog));
    fail_unless_equal("Result", "%" PRIu64, 10, bws_gauge_add(dog, 10));
    ...
    fail_unless_equal("Result", "%" PRIu64,  4, bws_gauge_inc(frog));
    fail_unless_equal("Result", "%" PRIu64,  5, bws_gauge_sub(cat, 5));
    ...
    fail_unless_equal("Result", "%" PRIu64,  3, bws_gauge_dec(frog));
    fail_unless_equal("Result", "%" PRIu64,  2, bws_gauge_dec(frog));
    fail_unless_equal("Result", "%" PRIu64,  0, bws_gauge_sub(dog, 10));
...
START_TEST(test_multi_01)
{
    ...
    fail_unless_equal("Result", "%" PRIu64, 10, bws_derive_add(tx, 10));
    fail_unless_equal("Result", "%" PRIu64, 20, bws_derive_add(rx, 20));
